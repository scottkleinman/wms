...
def index():
	"""Corpus index page."""
	scripts = ['js/corpus/corpus.js', 'js/dateformat.js', 'js/jquery-ui.js']
...
def create():
	...
	scripts = ['js/parsley.min.js', 'js/corpus/corpus.js', 'js/dateformat.js' , 'js/jquery-ui.js', 'js/moment.min.js']
...
def search2():
	...
	scripts = ['js/query-builder.standalone.js', 'js/moment.min.js', 'js/jquery.twbsPagination.min.js', 'js/corpus/corpus.js', 'js/jquery-sortable-min.js', 'js/corpus/search.js', 'js/dateformat.js', 'js/jquery-ui.js']
